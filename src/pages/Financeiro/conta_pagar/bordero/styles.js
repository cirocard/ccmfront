...
export const ToolBar = styled.div`
  ...
  padding-top: ${(props) => props.ptop || 100}px;
...
export const GridContainerTitulos = styled.div`
  display: flex;
  flex-direction: column;
  width: 100%;
  padding: 8px 5px 0 0;
...
export const GridContainerMain = styled.div`
  ...
  .warn-baixado {
    background-color: #c6fdd3 !important;
  }

  .warn-aberto {
    background-color: #f6fdc6 !important;
  }
  .warn-cancelado {
    background-color: #fdcdc6 !important;
  }
